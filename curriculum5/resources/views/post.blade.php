    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <form class="card mb-3" style="width: 35rem;" action="{{ action('PostController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="p-3">
                        <input type="submit" class="btn btn-success float-right " value="つぶやく">
                    </div>
                </form>
                  <!-- 一覧ここから -->
                  <div>
